...
> Our team met the sprint goal and was able to complete all required user stories for the project. Any issue that would be placed on the backlog was minor enough not to include for the product we were required to complete.
...
#### David Berry:
  **Links to GitHub commits with main code contribution (up to 5 links) - all Sprints:
    ...
    - [link1](https://github.com/sjgarc20/TheFloorIsJava-Memoranda/tree/us43task78)
...
#### Jonathan Blicharz:
  **Links to GitHub commits with main code contribution (up to 5 links) - all Sprints:
    ...
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/tree/us97
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/tree/us109
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/tree/us42task74
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/tree/us42task75

  **GitHub links to your Code Reviews (up to 3 links) -- Sprint 2 and 3:

    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/32
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/28
    - https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/26
 
 **What was your main contribution to the Quality Policy documentation?:

    - The quality policy was done as a group.
...
#### Sam Garcia:
  **Links to GitHub commits with main code contribution (up to 5 links) - all Sprints:
   ...
   - [link1]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/32
   - [link2]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/19
   - [link3]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/8

  **GitHub links to your Code Reviews (up to 3 links) -- Sprint 2 and 3:

    - [link1]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/14
    - [link2]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/24
    - [link3]https://github.com/sjgarc20/TheFloorIsJava-Memoranda/pull/31
